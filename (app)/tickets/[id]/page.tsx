...
import { type Ticket, type TicketSubtask, type TicketPhoto, type TicketActivity } from "@/lib/types/database";
...
export default async function TicketPage({ params }: TicketPageProps) {
  ...
  const [subtasksRes, rawPhotosRes, activityRes, currentUserRes, staffRes] = await Promise.all([
    supabase
  ...
  const assignableStaff = (staffRes.data ?? []) as { id: string; name: string }[];
